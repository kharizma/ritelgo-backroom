                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" name="email" class="form-control text-bg-secondary" value="{{ $user->email }}" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="mobile_phone" class="form-control" placeholder="81323234293" value="{{ ltrim($user->mobile_phone,'62') }}" required>
                            </div>
                        </div>
                    </div>
